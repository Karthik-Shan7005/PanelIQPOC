...
run(
    ...
    '--noconsole '
    '--add-data ".env;." '
    # collect-all bundles the ENTIRE package (submodules + data files)
    # This is stronger than --hidden-import and fixes "No module named X" errors
    '--collect-all=fastapi '
    ...
    '--collect-all=anyio '
    '--collect-all=dotenv '
    # Explicit hidden imports for runtime-only entries
